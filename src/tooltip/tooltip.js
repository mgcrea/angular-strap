  ...
  .provider('$tooltip', function() {
    ...
    this.$get = function(
      ...
      function TooltipFactory(element, config) {
        ...
        var scope = $tooltip.$scope = options.scope && options.scope.$new() ||
          $rootScope.$new();
        ...
        $tooltip.init = function() {
          ...
          angular.forEach(triggers, function(trigger) {
            if (trigger === 'click') {
              ...
              element.on(
                trigger === 'hover' ? 'mouseenter' : 'focus', $tooltip.enter
              );
              element.on(
                trigger === 'hover' ? 'mouseleave' : 'blur', $tooltip.leave
              );
        ...
        $tooltip.toggle = function() {
          $tooltip[$tooltip.$isShown ? 'leave' : 'enter']();
        };
        ...
        $tooltip.$applyPlacement = function() {
          ...
          // Get the tooltip's top and left coordinates to center it with this
          // directive.
          var tipPosition = getCalculatedOffset(
            options.placement, elementPosition, tipWidth, tipHeight
          );
        ...
        $tooltip.$onFocusElementMouseDown = function(evt) {
          ...
          element[0][$tooltip.$isShown ? 'blur' : 'focus']();
        };
        ...
        function getCalculatedOffset(
          placement, position, actualWidth, actualHeight
        ) {
          var offset;
