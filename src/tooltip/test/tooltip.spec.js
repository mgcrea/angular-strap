...
describe('tooltip', function () {
  ...
  var templates = {
    ...
    'custom-template': {
      ...
      element: '<a title="bar" data-template="customTooltip" bs-tooltip>hover me</a>'
    },
    'options-placement': {
  ...
  describe('with default template', function () {
    ...
    it('should support custom template', function() {
      $templateCache.put('customTooltip', '<div class="tooltip"><div class="tooltip-inner">foo: {{title}}</div></div>');
    ...
    it('should support template with ngRepeat', function() {
      $templateCache.put('customTooltip', '<div class="tooltip"><div class="tooltip-inner"><ul><li ng-repeat="item in items">{{item}}</li></ul></div></div>');
      var elm = compileDirective('custom-template');
      angular.element(elm[0]).triggerHandler('mouseenter');
    ...
    it('should support template with ngClick', function() {
      $templateCache.put('customTooltip', '<div class="tooltip"><div class="tooltip-inner"><a class="btn" ng-click="foo.bar=foo.bar+1">click me</a></div></div>');
      var elm = compileDirective('custom-template');
      angular.element(elm[0]).triggerHandler('mouseenter');
