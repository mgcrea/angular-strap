...
describe('datepicker', function () {
	...
	describe('options', function () {
		...
		describe('dateFormat', function () {
			...
			it("should allow for fallback formats", function () {
				var elm = compileDirective('options-dateFormat-fallback', {
					selectedDate: new Date(2017, 0, 2)
				});
				scope.$digest();
				expect(elm.val()).toBe("1/2/17");
				...
				var newDate = new Date(2018, 6, 4);

				expect(String(scope.selectedDate)).toBe(String(newDate));
			});
